...
class EDD_Theme_Updater_Admin {
					...
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								...
								if ( 'valid' == $status ) { ?>
									<input type="submit" class="button-secondary" name="<?php echo $this->theme_slug; ?>_license_deactivate" value="<?php esc_attr_e( $strings['deactivate-license'], 'wikipress' ); ?>"/>
								<?php } else { ?>
									<input type="submit" class="button-secondary" name="<?php echo $this->theme_slug; ?>_license_activate" value="<?php esc_attr_e( $strings['activate-license'], 'wikipress' ); ?>"/>
								<?php }
								?>
							</td>
						</tr>
	...
	function activate_license() {
		...
		if ( $license_data && isset( $license_data->price_id ) ) {
			update_option( $this->theme_slug . '_license_price_id', $license_data->price_id );
		}
	...
	function deactivate_license() {
		...
		//herothemes mod - set license price_id
		if ( $license_data && isset( $license_data->price_id ) ) {
			delete_option( $this->theme_slug . '_license_price_id' );
		}
	}
